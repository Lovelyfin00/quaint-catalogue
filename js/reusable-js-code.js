...
function storeCartId(itemCartArray, keyAndValue) {
  ...
  existingProductsCart = existingProductsCart
    ? JSON.parse(existingProductsCart)
    : [];
  ...
  window.localStorage.setItem(
    "itemCartArray",
    JSON.stringify(existingProductsCart)
  );
}

function storeprices(price) {
  // Get the existing data
  ...
  window.localStorage.setItem(
    "itemPriceArray",
    JSON.stringify(existingPriceArray)
  );
}
